...
export const ENUM_SLICED = "Skåret?";
export const ENUM_DRIED = "Tørket";
export const ENUM_PITTED = "??";
export const ENUM_CORED = "??";
export const ENUM_GRATED = "Gratert?";
export const ENUM_MASHED = "Most";
export const ENUM_CRUSHED = "Most?";
...
export const ENUM_SWINE = "Svin";
export const ENUM_POULTRY = "Fjærkre";
export const ENUM_FOWL = "Fjærkre";
export const ENUM_BIRD = "Fjærkre";
export const ENUM_EGG = "Egg";
export const ENUM_FISH = "Fisk";
